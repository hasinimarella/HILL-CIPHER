...
int main() {
  char msg[] = "HASINI", enc[100], dec[100];
  hill(msg, enc, 1); printf("Encrypted: %s\n", enc);
  hill(enc, dec, 0); printf("Decrypted: %s\n", dec);
}
```
## OUTPUT:
<img width="1616" height="726" alt="Screenshot 2025-08-25 142914" src="https://github.com/user-attachments/assets/e969a41a-ce0b-4244-857b-24737c2f7905" />

## RESULT:
Thus the execution of the Hill Cipher has executed successfully.
